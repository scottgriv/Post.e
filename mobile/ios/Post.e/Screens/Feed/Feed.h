...
@interface Feed : UIViewController <UITableViewDelegate, UITableViewDataSource, UIActionSheetDelegate, LoveManagerDelegate, PinManagerDelegate>

//Objects
@property (strong, nonatomic) IBOutlet UIView *feedView; //Feed View
@property (strong, nonatomic) IBOutlet UITableView * feedTable; //Profile Table
...
@property (nonatomic, assign) BOOL noPostsFlag; //No Post Flag
...
@property (nonatomic, assign) BOOL homeFlag;
@property (nonatomic, assign) BOOL newUserFlag;
...
@property (strong, nonatomic) IBOutlet UIButton *feedBtn;
