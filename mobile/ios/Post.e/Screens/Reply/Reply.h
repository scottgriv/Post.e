...
@interface Reply : UIViewController <UITableViewDelegate, UITableViewDataSource, UIActionSheetDelegate, LoveManagerDelegate, PinManagerDelegate>

//Objects
@property (strong, nonatomic) IBOutlet UIView *replyView; //Reply View
@property (strong, nonatomic) IBOutlet UITableView * replyTable; //Profile Table
...
@property (strong, nonatomic) IBOutlet UIButton *postBtn; //Post Button
...
@property (nonatomic, strong) NSMutableArray * postAttachmentHeaderJSON; //Post Attachment JSON Array
...
@property (nonatomic, strong) NSMutableArray * postAttachmentHeaderArray; //Post Attachment Array
...
@property (nonatomic, assign) BOOL refreshTable; //Refresh Table Flag
@property (nonatomic, assign) BOOL noPostsFlag; //No Posts Flag
...
@property (readwrite, assign) NSInteger replyPostID;
